...
def load_map_8():
    game_data = {
        ...
        'items_list': [],
        'statues_list': [],
        'custom_images_list': [{'rect': (520.0, 600.0, 175.0, 273.0), 'source_file_path': 'Custom/OIP-C.jpg', 'original_width': 474, 'original_height': 629, 'layer_order': 0, 'properties': {'is_background': False, 'is_obstacle': True, 'destructible': True, 'health': 1, 'scroll_factor_x': 1.0, 'scroll_factor_y': 1.0, 'apply_gravity': True}, 'is_flipped_h': False, 'rotation': 0}],
