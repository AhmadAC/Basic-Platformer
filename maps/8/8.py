...
def load_map_8():
    game_data = {
        ...
        'statues_list': [],
        'custom_images_list': [{'rect': (160.0, 600.0, 175.0, 273.0), 'source_file_path': 'Custom/OIP-C.jpg', 'original_width': 474, 'original_height': 629, 'crop_rect': {'height': 629, 'width': 471, 'x': 0, 'y': 0}, 'layer_order': 10, 'properties': {'apply_gravity': True, 'destructible': False, 'health': 100, 'is_background': False, 'is_obstacle': True, 'opacity': 48, 'scroll_factor_x': 1.0, 'scroll_factor_y': 1.0}, 'is_flipped_h': False, 'rotation': 0}],
