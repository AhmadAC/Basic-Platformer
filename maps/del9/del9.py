...
def load_map_del9():
    game_data = {
        ...
        'custom_images_list': [],
        'trigger_squares_list': [{'rect': (800.0, 920.0, 80.0, 80.0), 'layer_order': 0, 'properties': {'visible': True, 'fill_color_rgba': (100, 100, 255, 100), 'image_in_square': '', 'linked_map_name': '', 'trigger_event_type': 'player_enter', 'one_time_trigger': True, 'activation_id': ''}, 'is_flipped_h': False, 'rotation': 0}, {'rect': (600.0, 920.0, 80.0, 80.0), 'layer_order': 0, 'properties': {'visible': True, 'fill_color_rgba': (100, 100, 255, 100), 'image_in_square': '', 'linked_map_name': 'three', 'trigger_event_type': 'player_enter', 'one_time_trigger': True, 'activation_id': ''}, 'is_flipped_h': False, 'rotation': 0}],
