...
def load_map_chest():
    game_data = {
        ...
        'enemies_list': [],
        'items_list': [{'pos': (661.0, 745.0), 'type': 'chest', 'properties': {'item_type': 'coin', 'item_quantity': 1, 'requires_key_id': '', 'last_visible_opacity': 100, 'opacity': 100}, 'is_flipped_h': False, 'rotation': 0}, {'pos': (421.0, 665.0), 'type': 'chest', 'properties': {'item_type': 'coin', 'item_quantity': 1, 'requires_key_id': ''}, 'is_flipped_h': False, 'rotation': 0}, {'pos': (541.0, 625.0), 'type': 'chest', 'properties': {'item_type': 'coin', 'item_quantity': 1, 'requires_key_id': ''}, 'is_flipped_h': False, 'rotation': 0}],
        'statues_list': [],
        'custom_images_list': [{'rect': (12.0, 17.0, 1575.0, 961.0), 'source_file_path': 'Custom/BB1msOZ9.jpg', 'original_width': 1280, 'original_height': 720, 'layer_order': -1, 'properties': {'apply_gravity': False, 'destructible': False, 'health': 100, 'is_background': True, 'is_obstacle': False, 'opacity': 81, 'scroll_factor_x': 1.0, 'scroll_factor_y': 0.0, 'last_visible_opacity': 81}, 'is_flipped_h': False, 'rotation': 0}],
