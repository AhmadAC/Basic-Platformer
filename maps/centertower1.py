...
def load_map_centertower1(initial_screen_width, initial_screen_height):
    ...
    """
    print(f"Loading map: load_map_centertower1...")
    ...
    print(f"Map 'load_map_centertower1' loaded with: {len(platforms)} platforms, {len(ladders)} ladders, {len(hazards)} hazards.")
