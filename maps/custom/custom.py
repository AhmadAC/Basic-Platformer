...
def load_map_custom():
    game_data = {
        ...
        'items_list': [],
        'statues_list': [],
        'custom_images_list': [{'rect': (400.0, 320.0, 474.0, 629.0), 'source_file_path': 'Custom/OIP-C.jpg', 'original_width': 474, 'original_height': 629, 'layer_order': 0, 'properties': {'apply_gravity': False, 'destructible': False, 'health': 93, 'is_background': True, 'is_obstacle': False, 'last_visible_opacity': 42, 'opacity': 61, 'scroll_factor_x': 1.0, 'scroll_factor_y': 1.0}, 'is_flipped_h': False, 'rotation': 0}],
