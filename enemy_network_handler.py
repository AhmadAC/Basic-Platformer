...
# from enemy import Enemy  # <--- REMOVE THIS LINE (Original line 20)

if TYPE_CHECKING:
    from enemy import Enemy # <--- ADD THIS LINE for type checking and IDEs
...
# Optionally, add type hints using string literals if desired for clarity:
# def get_enemy_network_data(enemy: 'Enemy') -> Dict[str, Any]:
def get_enemy_network_data(enemy) -> Dict[str, Any]: # Original signature
...
def set_enemy_network_data(enemy, network_data: Dict[str, Any]): # Original signature
