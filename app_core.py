...
try:
    ...
    try:
        from client_logic import ClientState # This imports game_setup (deferred)
    except ImportError:
    ...
    try:
        from couch_play_logic import run_couch_play_mode # This imports game_setup (deferred)
    except ImportError:
